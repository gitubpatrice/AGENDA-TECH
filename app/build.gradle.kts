...
kotlin {
    compilerOptions {
        ...
        freeCompilerArgs.addAll(
            ...
            // No `-Xannotation-default-target=param-property` since Kotlin 2.4: param-property is the
            // default there (KT-73255) and the compiler reports the argument as redundant.
        )
    }
}
